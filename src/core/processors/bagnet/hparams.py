...
class HPARAMS(Enum):
    ...
    """
    MODEL_BAGNET = Hyperparameter(int, [9, 17, 33])
    MODEL_PRETRAINED = Hyperparameter(bool, [False])
    DATA_MIN_ITEM_PER_CLASS = Hyperparameter(int, [100, 50, 200])
    DATA_BATCH_SIZE = Hyperparameter(int, [8, 16, 32])
