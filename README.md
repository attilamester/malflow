...
* install Radare2, using release 6.0.4: https://github.com/radareorg/radare2/releases/tag/6.0.4
...
* install the pre-commit hook & run the tests:
```bash
pre-commit install
pre-commit run
# or
docker compose up --build malflow_test
```
